...
//
// V2 CHANGES:
// - Iframe is vertically centered within the container when content
//   is shorter than the minimum height
//
// USAGE:
...
class CalendlyWidget extends HTMLElement {
  ...
  updateHeight(height) {
    ...
    if (container && iframe) {
      // Set iframe to exact content height
      iframe.style.height = `${height}px`;

      // If content is taller than min-height, expand container
      // Otherwise, container stays at min-height and iframe is centered via flexbox
